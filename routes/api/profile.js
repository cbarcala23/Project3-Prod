...
// @access  Private
// the second parameter auth means the route is protected by authentication by the middleware
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      //push to array , beginning of using unshift
...
router.delete("/experience/:exp_id", auth, async (req, res) => {
  try {
    // Get profile by user id logged in
    const profile = await Profile.findOne({ user: req.user.id });
    // Get remove index
